# -*- coding: utf-8 -*-
"""
Created on Tue Aug 02 23:43:37 2022
...
def index():
    ...
    Call this api passing the following parameters - 
        ...
        Number of Clusters
    Sample URL: http://localhost:8180/unguided_cluster?col=text&no_of_clusters=3
    ---
    tags:
      - Clustering API
    parameters:
...
def index_guided():
    ...
    Sample URL : http://localhost:8180/guided_cluster?col=text
    ---
    tags:
      - Clustering API
    parameters:
